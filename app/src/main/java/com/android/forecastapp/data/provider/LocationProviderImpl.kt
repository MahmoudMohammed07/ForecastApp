...
import com.android.forecastapp.internal.LocationPermissionNotGrantedException
import com.android.forecastapp.internal.asDeferred
...
class LocationProviderImpl(
    ...
    private fun getLastDeviceLocation(): Deferred<Location?> {
        return if (hasLoctionPermission())
            fusedLocationProviderClient.lastLocation.asDeferred()
        else
            throw LocationPermissionNotGrantedException()
    }

    private fun hasLoctionPermission(): Boolean {
